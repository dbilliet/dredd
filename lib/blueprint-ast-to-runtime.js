...
blueprintAstToRuntime = function(blueprintAst, filename) {
  var action, actionParameters, example, exampleIndex, i, index, j, k, l, len, len1, len2, len3, len4, len5, len6, len7, m, message, n, o, origin, p, parameters, paramsResult, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, resource, resourceGroup, resourceParameters, result, runtime, transaction, uriResult;
  runtime = {
    transactions: [],
    errors: [],
    warnings: []
    ...
    for (j = 0, len1 = ref1.length; j < len1; j++) {
      ...
      for (k = 0, len2 = ref2.length; k < len2; k++) {
        ...
        if (uriResult['uri'] !== null) {
          ...
          for (exampleIndex = o = 0, len6 = ref6.length; o < len6; exampleIndex = ++o) {
            example = ref6[exampleIndex];
